...
数据集：peoples_daily（PER / ORG / LOC，BIO 格式）
...
MODEL_PATH  = Path("/Users/xubin/Documents/www/py/llm/model/Qwen/Qwen2-0.5B-Instruct")
ADAPTER_DIR = ROOT / "outputs" / "sft_adapter"
LOG_DIR     = ROOT / "outputs" / "logs"

from train_sft import ENTITY_TYPES, SYSTEM_PROMPT, record_to_text
...
def gold_spans_from_record(record: dict) -> set[tuple[str, str, int, int]]:
    """从 peoples_daily BIO 标注提取 gold spans，格式 (text, type, start, end)。"""
