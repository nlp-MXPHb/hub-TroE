"""
BERT NER 训练脚本（人民日报 NER / peoples_daily）
...
数据集：peoples_daily，3 类实体（PER / ORG / LOC），BIO 标注
...
def main():
    ...
    # 标签体系（从 label_names.json 读取：O / B-PER / I-PER / B-ORG / I-ORG / B-LOC / I-LOC）
...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=Path, default=DATA_DIR, help="数据集目录")
