...
使用方式：
  ...
  python evaluate.py --model_type biencoder --ckpt ../outputs/checkpoints/biencoder_cosine_best.pt --data_dir ../data/lcqmc
  
  python evaluate.py --model_type biencoder --ckpt ../outputs/checkpoints/biencoder_triplet_best.pt --data_dir ../data/lcqmc

  python evaluate.py --model_type crossencoder --ckpt ../outputs/checkpoints/crossencoder_best.pt --data_dir ../data/lcqmc
...
BERT_PATH  = "/Users/zhanglei/projects/llm-bootcamp/pretrain_models/bert-base-chinese"
